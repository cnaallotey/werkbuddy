            ...
            >
              ...
              >
                <span class="block xl:inline"
                  >For students seeking internships or contract work, and
                </span>
                <span class="block text-indigo-600 xl:inline" data-primary="indigo-600"
                  >for graduates or professionals looking for full-time positions.</span
                >
              </h1>
              <!-- <p
                class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl"
              >
                It's never been easier to build beautiful websites that convey your
