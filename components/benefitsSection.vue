<template>
  <div>
    <div class="py-16 bg-gray-505 overflow-hidden lg:py-0">
      <div class="relative max-w-full mx-auto px-4 sm:px-6 lg:px-0">
        <div
          class="relative mt-0 lg:mt-0 lg:grid lg:grid-cols-2 lg:gap-0 lg:items-center"
        >
          <div class="w-full h-full flex items-center lg:ml-20">
            <div class="relative w-fit">
              <h3
                class="text-2xl font-extrabold text-gray-900 tracking-tight sm:text-3xl"
              >
                Werkbuddy at a glance
              </h3>
              ...
              <dl class="mt-10 space-y-10 lg:space-y-20">
                <div class="relative">
        ...
        <div
          class="relative mt-12 lg:mt-0 lg:grid lg:grid-cols-2 lg:gap-0 lg:items-center"
        >
          <div class="w-full h-full flex items-center lg:ml-20 order-2">
            <div class="relative w-fit">
              <h3
                class="text-2xl font-extrabold text-gray-900 tracking-tight sm:text-3xl hidden"
              >
                Werkbuddy at a glance
              </h3>
              <p class="mt-3 text-lg text-gray-500 hidden">
          ...
          <div class="mt-10 -mx-0 relative lg:mt-0 order-1" aria-hidden="true">
            <div class="w-full h-full bg-red-50 mx-auto">
              <img
                class="w-full h-full object-cover object-center"
