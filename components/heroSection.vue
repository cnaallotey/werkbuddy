    ...
    <div class="relative bg-black overflow-hidden">
      ...
      <div class="relative pt-6 pb-16 sm:pb-24">
        <div>
          ...
          <div
            class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right hidden"
          >
            <div
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-5">
              ...
              >
                <div>
                  <a
                    href="#"
                    class="lg:inline-flex flex flex-col lg:flex-row items-center text-white bg-gray-900 rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200"
                  >
                    <span
