  ...
  <div>
    <div class="relative bg-black overflow-hidden">
      ...
      <div class="relative pt-6 pb-16 sm:pb-24">
        <div
          class="max-w-screen-xl mx-auto flex items-center justify-between gap-10 px-4"
        >
          <a href="/" class="inline-flex shrink-0">
            <img src="/images/logo.png" class="h-12 md:h-14 shrink-0 w-auto" alt="logo" />
            <span class="sr-only">logo</span>
          </a>
          <a
            href="/catchup-plus/register"
            class="inline-flex gap-2 bg-indigo-600 px-6 py-4 rounded-lg hover:bg-indigo-700 transition text-white font-medium"
          >
            Register
          </a>
        </div>
          ...
          <div class="mx-auto max-w-7xl">
            <div class="lg:grid lg:grid-cols-12 lg:gap-5">
              ...
              <div class="mt-16 sm:mt-24 lg:mt-0 lg:col-span-6 px-4">
                ...
                <div
                  class="bg-white sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden hidden"
                >
